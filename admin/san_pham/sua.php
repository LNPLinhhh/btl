					...
					<form action="./sua_thuc_hien.php" method="POST" enctype="multipart/form-data">
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group">
									<label> Size</label>
									<input name="size" type="gia_giam" class="form-control" value="<?php echo $row['size'] ?>"  required >
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									<label>Màu</label>
									<input name="mau" type="gia_giam" class="form-control" value="<?php echo $row['mau'] ?>"  required >
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
